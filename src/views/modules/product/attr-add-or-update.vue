...
export default {
  data() {
    return {
      visible: false,   //新增和修改，共用一个对话框，默认不可见
      dataForm: { 
        attrId: 0,      //属性id，由数据库生成
        attrName: "",   //属性名，用户自定义
        searchType: 0,  //是否可检索，0不可检索
        valueType: 0,   //值类型，0单个值，1多个值
        icon: "xxx",    //属性图标
        valueSelect: "",//可选值
        attrType: 1,    //属性类型,规格参数1，销售属性0
        enable: 1,      //启用状态,1启动
        catelogId: "",  //三级分类id
        attrGroupId: "",//属性分组id
        showDesc: 0     //快速展示，1快速展示
      },
      catelogPath: [],
      attrGroups: [],
      dataRule: {
